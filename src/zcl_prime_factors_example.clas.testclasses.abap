CLASS ltcl_prime_factor DEFINITION FOR TESTING DURATION SHORT RISK LEVEL HARMLESS FINAL.
  ...
  PRIVATE SECTION.
    DATA cut TYPE REF TO zcl_prime_factors_example.
...
CLASS ltcl_prime_factor IMPLEMENTATION.
  ...
  METHOD test_no_factors.
    DATA(expected_value) = VALUE zcl_prime_factors_example=>integertab( ).
  ...
  METHOD test_prime_number.
    DATA(expected_value) = VALUE zcl_prime_factors_example=>integertab( ( 2 ) ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->factors( 2 )
      exp = expected_value ).
  ENDMETHOD.
  ...
  METHOD test_another_prime_number.
    DATA(expected_value) = VALUE zcl_prime_factors_example=>integertab( ( 3 ) ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->factors( 3 )
      exp = expected_value ).
  ENDMETHOD.
  ...
  METHOD test_square_of_a_prime.
    DATA(expected_value) = VALUE zcl_prime_factors_example=>integertab( ( 3 ) ( 3 ) ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->factors( 9 )
      exp = expected_value ).
  ENDMETHOD.
  ...
  METHOD test_product_of_first_prime.
    DATA(expected_value) = VALUE zcl_prime_factors_example=>integertab( ( 2 ) ( 2 ) ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->factors( 4 )
      exp = expected_value ).
  ENDMETHOD.
  ...
  METHOD test_cube_of_a_prime.
    DATA(expected_value) = VALUE zcl_prime_factors_example=>integertab( ( 2 ) ( 2 ) ( 2 ) ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->factors( 8 )
      exp = expected_value ).
  ENDMETHOD.
  ...
  METHOD test_product_of_second_prime.
    DATA(expected_value) = VALUE zcl_prime_factors_example=>integertab( ( 3 ) ( 3 ) ( 3 ) ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->factors( 27 )
      exp = expected_value ).
  ENDMETHOD.
  ...
  METHOD test_product_of_third_prime.
    DATA(expected_value) = VALUE zcl_prime_factors_example=>integertab( ( 5 ) ( 5 ) ( 5 ) ( 5 ) ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->factors( 625 )
      exp = expected_value ).
  ENDMETHOD.
  ...
  METHOD test_product_first_sec_prime.
    DATA(expected_value) = VALUE zcl_prime_factors_example=>integertab( ( 2 ) ( 3 ) ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->factors( 6 )
      exp = expected_value ).
  ENDMETHOD.
  ...
  METHOD test_product_primes_non_prime.
    DATA(expected_value) = VALUE zcl_prime_factors_example=>integertab( ( 2 ) ( 2 ) ( 3 ) ).
    cl_abap_unit_assert=>assert_equals(
      act = cut->factors( 12 )
      exp = expected_value ).
  ENDMETHOD.
  ...
  METHOD test_product_of_primes.
    DATA(expected_value) = VALUE zcl_prime_factors_example=>integertab( ( 5 ) ( 17 ) ( 23 ) ( 461 ) ).
    cl_abap_unit_assert=>assert_equals(
  ...
  METHOD test_factors_large_prime.
    DATA(expected_value) = VALUE zcl_prime_factors_example=>integertab( ( 11 ) ( 9539 ) ( 894119 ) ).
    cl_abap_unit_assert=>assert_equals(
